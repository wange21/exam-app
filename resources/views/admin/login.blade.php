...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form class="form-horizontal login-form form-box" role="form" method="POST" action="{{ url('admin/login') }}">
                {!! csrf_field() !!}
                <legend>老师登录</legend>
                ...
                <div class="form-group">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div>
                            <a class="btn btn-link" href="{{ url('admin/register') }}">立即注册</a>
                            <a class="btn btn-link pull-right" href="{{ url('admin/password/reset') }}">忘记密码？</a>
                        </div>
                    </div>
                </div>
            </form>
